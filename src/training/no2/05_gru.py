"""
Model 4: Small GRU network – NO2
Uses a sequence of the last 6 hours to predict NO2 1 hour ahead.
"""
...
torch.save(model.state_dict(), "../../../Data/models/no2/gru_model.pt")
with open("../../../Data/models/no2/gru_scaler.pkl", "wb") as f:
